...
public class AsistenciaController {
    ...
    @PostMapping("/crear")
    public ResponseEntity<Asistenciax> createActividad(@RequestBody Asistenciax actividad) {
    ...
    public ResponseEntity<Asistenciax> getActividadById(@PathVariable Long id) {
        Asistenciax actividad = asistenciaXService.getActividadById(id);
    ...
    public ResponseEntity<Asistenciax> updateActividad(@PathVariable("id") Long id,
            @RequestBody Asistenciax asistenciaxDetails) {
